...
public class InternationalFlight extends JFrame
{
	...
	{
		//containers are an important component for web applications
		Container c =getContentPane();
		c.setLayout(new BorderLayout());
		//international flight details
		String[] sItem1={"Tanzania"};
		String[] sItem2={"Bali","Bangkok","Hamburg","Ames","Chicago","Dubai","Frankfurt","HongKong","Istanbul","London","LosAngeles","Melbourne","New York","Paris","Rome","SanFrancisco","shanghai","Singapore","Sydney","Toronto"};
		...
		//bounds are setted for all things
		...
		//adding everything to the panel1
