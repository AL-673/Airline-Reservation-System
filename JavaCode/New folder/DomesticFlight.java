...
public class DomesticFlight extends JFrame
{
	...
	public DomesticFlight(LoginPage type1)
	{
		...
		String[] sItem2 ={ "Johannesberg", "Cairo ", "Cape Town", "Casablanca", "Lagos", "Tunis", "Alexandria", "Durban", "Abuja" };
		String[] sItem3={"Economic","Business"};

		this.type1 = type1;
		PPanel1 = new JPanel(null);
		//dimensions are set for the panel
		...
		//bounds are set for all the things
